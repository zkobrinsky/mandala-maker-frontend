const urlPath = window.location.href.includes("localhost")
  ? "http://localhost:3001"
  : "https://mandala-maker.herokuapp.com";

export const getSketches = () => {
  console.log(urlPath);
  return dispatch => {
    fetch(`${urlPath}/sketches`, {
      method: "GET",
      headers: {
...
export const getSketch = id => {
  return dispatch => {
    return fetch(`${urlPath}/sketches/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
