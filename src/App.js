    ...
    <div className="App">
      ...
      <MyNav />
        <Switch>
          ...
          <Route exact path="/sketches"><Sketches/></Route> 
          <Route exact path="/sketches/new"><CreateSketch/></Route>
          <Route exact path="/sketches/:id">{(routerProps) => <SketchShow {...routerProps}/>}</Route>
